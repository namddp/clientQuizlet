...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <nav className="navigation h-full">
        <ul className="h-full flex gap-6">
          ...
          >
            <Link href="/" className="text-[.875rem] font-bold">
              <Text color="#2e3856">Trang chủ</Text>
            </Link>
          </li>
          <li
            className={classNames(
          ...
          >
            <Link href="/" className="text-[.875rem] font-bold">
              <Text color="#2e3856">Lời giải chuyên gia</Text>
            </Link>
          </li>
        </ul>
      </nav>
      ...
      <div className="flex gap-2">
        <div className="relative">
          ...
          <div className="w-full relative">
            <Menu isOpen={isOpen}>
              <MenuList className="absolute top-2 flex flex-col gap-3">
                <div className="flex items-center gap-2 px-4 py-2 font-bold hover:bg-[#edeff4] hover:cursor-pointer text-sm">
                  <CopyIcon color="#586380" />
                  <Text color="#586380">Học phần</Text>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 font-bold hover:bg-[#edeff4] hover:cursor-pointer text-sm">
                  <CopyIcon color="#586380" />
                  <Text color="#586380">Học phần</Text>
